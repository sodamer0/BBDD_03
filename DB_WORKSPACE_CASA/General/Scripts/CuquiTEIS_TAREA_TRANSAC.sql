...
SELECT COUNT(*) AS perros_a_eliminar FROM Perro WHERE id_raza = 3;

SELECT COUNT(*) AS participaciones_afectadas 
FROM Participacion_Evento 
WHERE id_perro IN (SELECT id_perro FROM Perro WHERE id_raza = 3);


DELETE FROM CuquiTEIS.Perro 
WHERE id_raza = 3;

SELECT COUNT(*) AS perros_restantes FROM Perro WHERE id_raza = 3;
...
VALUES (68, 'Trueno', '2023-01-15', 'Macho', 'Blanco', 25.5, 26);

SELECT * FROM Raza WHERE id_raza = 28;
